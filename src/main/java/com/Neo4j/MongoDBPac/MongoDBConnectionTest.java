...
public class MongoDBConnectionTest {
    ...
    //远程服务器链接
//    public static MongoClient remoteServideClient = remoteConnection("10.66.93.125");

    public static Neo4jtest neo4jtest = new Neo4jtest("bolt://192.168.199.202:7687", "neo4j", "09120912");
...
//            Matcher matcherInfoin = compile.matcher(matcherinfo.group());
            Map<String, String> strMapDetail = new HashMap<>();
            while (matcherDetailin.find()) {
//                System.out.println("mm:" + matcherDetailin.group(2));
//                System.out.println(matcherDetailin.group(4));
...
//        Document document = collection1.find(Filters.and(Filters.eq("data_source", "酒店"),Filters.eq("data_website", "携程"))).skip(1).first();
//        Document document =collection1.find().skip(2).first();
//        XieChengHotel xHotel = (XieChengHotel) DocumentConvextToModel("com.Neo4j.MongoDBPac.xiechengJavaBean.XieChengHotel", document);
//        System.out.println(xHotel.shop_room_recommend_all);
//        System.out.println(xHotel.shop_url);
        int i = 0;
